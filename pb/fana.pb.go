...
var file_fana_proto_rawDesc = []byte{
	...
	0x02, 0x49, 0x44, 0x32, 0xe2, 0x02, 0x0a, 0x04, 0x46, 0x61, 0x6e, 0x61, 0x12, 0x1d, 0x0a, 0x07,
	...
	,
...
var file_fana_proto_goTypes = []interface{}{
	...
	(*FlagFullResp)(nil),     // 5: FlagFullResp
	(*Flags)(nil),            // 6: Flags
	(*AudienceFullResp)(nil), // 7: AudienceFullResp
	(*Audiences)(nil),        // 8: Audiences
	(*AttributeResp)(nil),    // 9: AttributeResp
	(*Attributes)(nil),       // 10: Attributes
}
var file_fana_proto_depIdxs = []int32{
	...
	2,  // 6: Fana.CreateFlag:input_type -> FlagSubmit
	3,  // 7: Fana.CreateAudience:input_type -> AudSubmit
	4,  // 8: Fana.CreateAttribute:input_type -> AttrSubmit
	5,  // 9: Fana.GetFlag:output_type -> FlagFullResp
	6,  // 10: Fana.GetFlags:output_type -> Flags
	7,  // 11: Fana.GetAudience:output_type -> AudienceFullResp
	8,  // 12: Fana.GetAudiences:output_type -> Audiences
	9,  // 13: Fana.GetAttribute:output_type -> AttributeResp
	10, // 14: Fana.GetAttributes:output_type -> Attributes
	5,  // 15: Fana.CreateFlag:output_type -> FlagFullResp
	7,  // 16: Fana.CreateAudience:output_type -> AudienceFullResp
	9,  // 17: Fana.CreateAttribute:output_type -> AttributeResp
